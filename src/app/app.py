...
class App(
    ...
    def _get_widgets(self) -> bool:
        try:
            ...
            self.opt_edge_boost_check = self.builder.get_object("opt_edge_boost_check")
            self.opt_edge_boost_spin = self.builder.get_object("opt_edge_boost_spin")
            self.opt_use_edge_chars_check = self.builder.get_object("opt_use_edge_chars_check")
