...
```bash
wget https://github.com/[REDACTED]/Conversor-Video-Para-ASCII/releases/latest/download/extase-em-4r73_2.7.0_all.deb
sudo dpkg -i extase-em-4r73_2.7.0_all.deb
